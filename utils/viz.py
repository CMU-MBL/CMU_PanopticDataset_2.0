...
def generateVideo(args, vidName, bodyModel, bodyModelOutput, gtKeypoints, gtKeypointsConf, calibration=None):
    ...
    predVertices += (gtPelvis - predPelvis)

    # Project Keypoints onto Image
    predX2d, predMask = projectKeypoints(predKeypoints, imgRes, camK, camR, camT.T)
    gtX2d, gtMask = projectKeypoints(gtKeypoints, imgRes, camK, camR, camT.T, conf=gtKeypointsConf)
